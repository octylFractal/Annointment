...
public class RemoveCommand implements Command {
    ...
    public CommandResult execute(CommandSource src, CommandContext args)
        ...
        if (potentialUser instanceof User) {
            ...
            try {
                ...
                src.sendMessage(Texts
                        .of("Couldn't remove the flag: " + e.getMessage()));
            }
        }
        if (user == null) {
        ...
        try {
            AnnointmentDataManager.removeAnnointmentFlag(user,
                    /* TODO just for testing */ AnnointmentFlag.LOTS_OF_LIGHTNING);
            src.sendMessage(Texts.of("Removed the flag from ",
                    (user.isOnline()
            ...
            e.printStackTrace();
            src.sendMessage(
                    Texts.of("Couldn't remove the flag: " + e.getMessage()));
        }
        return CommandResult.empty();
    }
    ...
    public String getStringDescription() {
        return "Removes a user from the annointed list.";
    }
